document.addEventListener('DOMContentLoaded', () => {
    ...
    colorspaceButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            if (originalImageObject) debouncedEnhance();
        });
    });
    ...
    function calculateCovarianceMatrix(c1, c2, c3, m1, m2, m3) { /* ... same as before ... */ }
    function eigenDecomposition(matrix) { /* ... same as before ... */ }
    function convertRgbTo(r, g, b, colorspace) { /* ... same as before ... */ }
    function convertToRgb(c1, c2, c3, colorspace) { /* ... same as before ... */ }
    function rgbToLab(r, g, b) { /* ... same as before ... */ }
    function labToRgb(l, a, b_lab) { /* ... same as before ... */ }
});
